...
const Home = () => {
    const dummySongs = [
        { image: 'https://via.placeholder.com/80', title: 'Pookkal', artist: 'G.V Prakash' },
        { image: 'https://via.placeholder.com/80', title: 'Poo Nee Poo', artist: 'Anirudh' },
        { image: 'https://via.placeholder.com/80', title: 'Ava Enna', artist: 'Harris Jayaraj' },
    ];
    ...
    return (
        <div className="bg-black left-0 right-0 w-full px-0 min-h-screen text-white">
            <Header />
            <div className="px-4">
                <AlbumCard />
            </div>
